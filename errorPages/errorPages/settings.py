...
SECRET_KEY = 'django-insecure-(n^5+vvdp9vy0qbw*1(+j!^%&7wygsof7j&0-wn#c6s@ct$=5z'
...
CORS_ALLOWED_ORIGINS = [
    # IPS de las cuales ya tengo confianza
    "http://127.0.0.1:8000",
    "http://localhost:8000",
    "http://127.0.0.1:5173",
    "http://localhost:5173",
...
# GOOGLE_SEARCH_API = 'AIzaSyDTW23zmS_p1OvaBU278mvdv-SJrs-yh1A'
# ID_SEARCH_ENGINE = '17a86b1f0a715489b'
...
EMAIL_HOST_USER = "20223tn021@utez.edu.mx"
# Obtener de https://myaccount.google.com/apppasswords
EMAIL_HOST_PASSWORD = "dyeb wjnf xvki sbxm"